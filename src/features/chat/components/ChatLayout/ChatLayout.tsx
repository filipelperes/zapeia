...
function InputBar() {
  ...
  return (
      ...
      <button className="chat-input-icon p-1.5 text-gray-500 hover:text-gray-700 transition-colors" aria-label={t('chat.emoji')}>
      ...
      <button className="chat-input-icon p-1.5 text-gray-500 hover:text-gray-700 transition-colors" aria-label={t('chat.attach')}>
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
      ...
      <button className="chat-input-icon p-1.5 text-gray-500 hover:text-gray-700 transition-colors" aria-label={t('chat.send')}>
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
