...
export default interface Resources {
  "translation": {
    ...
    "emptyState": {
      "privacyNotice": "<1>Zapeia</1> is a local viewer. No data is sent to external servers. Everything runs exclusively in your browser.",
      "step1Description": "In the group/conversation, click <1>More → Export chat</1> and choose <2>without media</2>.",
      ...
      "watchingFile": "Watching <1>public/chat.txt</1> — the screen will update automatically as soon as the file is detected."
    },
    "error": {
